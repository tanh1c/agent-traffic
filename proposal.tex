...
\begin{titlepage}
    ...
    \textbf{HỒ SƠ DỰ ÁN}\\
    \textbf{GDGoC HACKATHON VIETNAM 2026}\\[2cm]

    \textbf{Tên đội:}\\
    {[TÊN ĐỘI - CẦN CẬP NHẬT]}\\[1.5cm]

    \textbf{Thành viên}\\[0.5cm]
    \begin{tabular}{|c|c|c|}
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|p{5.5cm}|p{5.5cm}|}
        ...
        \hline
        Độ chi tiết & Toàn tuyến, không phân biệt làn xe & Từng làn, từng loại phương tiện \\
        \hline
        Phát hiện sự cố & Không (chỉ thấy đỏ) & Phát hiện tai nạn, vật cản trực tiếp \\
        \hline
        Điều khiển đèn & Không thể & Có (tích hợp SCATS/ITMS API) \\
        \hline
...
\begin{itemize}
    ...
    \item \textbfChi phí:} Rất thấp (xem mục ngân sách bên dưới)
